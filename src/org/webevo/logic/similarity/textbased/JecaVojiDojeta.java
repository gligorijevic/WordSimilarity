...
//            List<String> slist = Arrays.asList("aggregateRating", "brand", "color", "depth", "gtin13", "gtin14", "gtin8", "height", "isAccessoryOrSparePartFor", "isConsumableFor", "thing", "isSimilarTo", "itemCondition", "logo", "manufacturer", "model", "mpn", "offers", "productID", "releaseDate", "review", "reviews", "sku", "weight", "width", "eligibleQuantity", "eligibleTransactionVolume", "maxPrice", "minPrice", "price", "priceCurrency", "validFrom", "validThrough", "valueAddedTaxIncluded", "acceptedPaymentMethod", "addOn", "advanceBookingRequirement", "aggregateRating", "availability", "availabilityEnds", "availabilityStarts", "availableDeliveryMethod", "businessFunction", "category", "deliveryLeadTime", "eligibleCustomerType", "eligibleDuration", "eligibleQuantity", "eligibleRegion", "eligibleTransactionVolume", "includesObject", "inventoryLevel", "itemCondition", "itemOffered", "mpn", "price", "priceCurrency", "priceSpecification", "priceValidUntil", "review", "reviews", "seller", "serialNumber", "sku", "validFrom", "validThrough", "warranty", "highPrice", "lowPrice", "offerCount", "isVariantOf", "predecessorOf", "successorOf", "amountOfThisGood", "businessFunction", "typeOfGood", "unitCode", "closes", "dayOfWeek", "opens", "validFrom", "validThrough", "billingIncrement", "priceType", "unitCode", "appliesToDeliveryMethod", "appliesToPaymentMethod", "additionalType", "description", "image", "name", "url", "description");
            ...
            /*Tačno*/
        List<String> flist = Arrays.asList("amountOfThisGood","availabilityEnds","availabilityStarts","billingIncrement","category","closes","color","condition","description","durationOfWarrantyInMonths","eligibleRegions","hasCurrency","hasCurrencyValue","hasDUNS","hasEAN_UCC-13","hasGlobalLocationNumber","hasGTIN-14","hasGTIN-8","hasISICv4","hasMaxCurrencyValue","hasMaxValue","hasMinCurrencyValue","hasMinValue","hasMPN","hasNAICS","hasStockKeepingUnit","hasUnitOfMeasurement","hasValue","legalName","name","opens","priceType","serialNumber","taxID","validFrom","validThrough","valueAddedTaxIncluded","vatID","acceptedPaymentMethods","addOn","advanceBookingRequirement","appliesToDeliveryMethod","appliesToPaymentMethod","availableAtOrFrom","availableDeliveryMethods","deliveryLeadTime","depth","eligibleCustomerTypes","eligibleDuration","eligibleTransactionVolume","equal","greater","greaterOrEqual","hasBrand","hasBusinessFunction","hasEligibleQuantity","hasInventoryLevel","hasMakeAndModel","hasManufacturer","hasOpeningHoursDayOfWeek","hasOpeningHoursSpecification","hasPOS","hasPriceSpecification","hasWarrantyPromise","hasWarrantyScope","height","includes","includesObject","isAccessoryOrSparePartFor","isConsumableFor","isSimilarTo","isVariantOf","lesser","lesserOrEqual","nonEqual","offers","owns","predecessorOf","seeks","successorOf","typeOfGood","valueReference","weight");
        List<String> slist = Arrays.asList("amountOfThisGood","availabilityEnds","availabilityStarts","billingIncrement","category","closes","color","itemCondition","description","durationOfWarranty","eligibleRegion","priceCurrency","price","duns","gtin13","globalLocationNumber","gtin14","gtin8","isicV4","maxPrice","maxValue","minPrice","minValue","mpn","manufacturer","sku","unitCode","value","legalName","name","opens","priceSpecification","serialNumber","taxID","validFrom","validThrough","valueAddedTaxIncluded","vatID","acceptedPaymentMethod","addOn","advanceBookingRequirement","appliesToDeliveryMethod","appliesToPaymentMethod","availableAtOrFrom","availableDeliveryMethod","deliveryLeadTime","depth","eligibleCustomerType","eligibleDuration","eligibleTransactionVolume","equal","greater","greaterOrEqual","brand","businessFunction","eligibleQuantity","inventoryLevel","model","manufacturer","dayOfWeek","openingHoursSpecification","hasPOS","priceSpecification","warranty","warrantyScope","height","includesObject","includesObject","isAccessoryOrSparePartFor","isConsumableFor","isSimilarTo","isVariantOf","lesser","lesserOrEqual","nonEqual","offers","owns","predecessorOf","seeks","successorOf","typeOfGood","valueReference","weight");
